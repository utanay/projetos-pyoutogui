...
pyautogui.alert(text='Aperte Ok para enviar o seu curriculo',title='Automação Envio de curriculo')
nome = pyautogui.prompt(text='Digite o seu nome completo:')
email = pyautogui.prompt(text='Digite o seu email:')
telefone = pyautogui.prompt(text='Digite o seu telefone, com o 91 na frente:')
